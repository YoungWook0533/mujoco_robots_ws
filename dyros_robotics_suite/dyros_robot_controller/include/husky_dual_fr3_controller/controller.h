...
namespace HuskyDualFR3Controller
{
    ...
    public:
        ...
        // ================================= Control Functions ================================
        // ====================================================================================
        VectorXd ManiPDControl(const VectorXd& q_mani_desired, const VectorXd& qdot_mani_desired, const Vector7d& q_mani_curr, const Vector7d& qdot_mani_curr);
    ...
    private :
        ...
        rclcpp::Publisher<geometry_msgs::msg::PoseStamped>::SharedPtr    r_ee_pose_pub_;
        rclcpp::Publisher<geometry_msgs::msg::PoseStamped>::SharedPtr    l_ee_pose_pub_;
        
        rclcpp::TimerBase::SharedPtr r_ee_pose_pub_timer_;
        rclcpp::TimerBase::SharedPtr l_ee_pose_pub_timer_;
        ...
        Vector7d r_q_mani_;
        Vector7d r_q_mani_init_;
        Vector7d r_q_mani_desired_;
        Vector7d r_qdot_mani_;
        Vector7d r_qdot_mani_init_;
        Vector7d r_qdot_mani_desired_;

        Vector7d l_q_mani_;
        Vector7d l_q_mani_init_;
        Vector7d l_q_mani_desired_;
        Vector7d l_qdot_mani_;
        Vector7d l_qdot_mani_init_;
        Vector7d l_qdot_mani_desired_;
        ...
        Affine3d r_x_goal_;
        Affine3d r_x_init_;
        Affine3d r_x_desired_;
        Vector6d r_xdot_;
        Vector6d r_xdot_init_;
        Vector6d r_xdot_desired_;

        Affine3d l_x_;
        Affine3d l_x_goal_;
        Affine3d l_x_init_;
        Affine3d l_x_desired_;
        Vector6d l_xdot_;
        Vector6d l_xdot_init_;
        Vector6d l_xdot_desired_;

        Vector2d mobile_vel_desired_;

        //// control input
        Vector7d r_torque_mani_desired_;
        Vector7d l_torque_mani_desired_;
