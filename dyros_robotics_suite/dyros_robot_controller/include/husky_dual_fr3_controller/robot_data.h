    ...
    */
    ...
    class RobotData
    {
        public:
            ...
            Matrix4d computePose(const VectorXd& q, const std::string& link_name=r_ee_name_);
            MatrixXd computeJacobian(const VectorXd& q, const std::string& link_name=r_ee_name_);
            MatrixXd computeJacobianActuated(const VectorXd& q, const std::string& link_name=r_ee_name_);
            MatrixXd computeJacobianTimeVariation(const VectorXd& q, const VectorXd& qdot, const std::string& link_name=r_ee_name_);
            Vector6d computeVelocity(const VectorXd& q, const VectorXd& qdot, const std::string& link_name=r_ee_name_);
            ...
            Matrix4d getPose(const std::string& link_name=r_ee_name_);
            MatrixXd getJacobian(const std::string& link_name=r_ee_name_);
            MatrixXd getJacobianActuated(const std::string& link_name=r_ee_name_);
            MatrixXd getJacobianTimeVariation(const std::string& link_name=r_ee_name_);
            Vector6d getVelocity(const std::string& link_name=r_ee_name_);
        ...
        private:
            ...
            // Task space state
            static constexpr const char* r_ee_name_ = "r_fr3_link8"; // end-effector link name
            static constexpr const char* l_ee_name_ = "l_fr3_link8"; // end-effector link name
            Matrix4d r_x_;         // pose of EE
            Vector6d r_xdot_;      // velocity of EE
            MatrixXd r_J_;         // jacobian of EE
            MatrixXd r_Jdot_;      // time derivative of jacobian of EE
            Matrix4d l_x_;         // pose of EE
            Vector6d l_xdot_;      // velocity of EE
            MatrixXd l_J_;         // jacobian of EE
            MatrixXd l_Jdot_;      // time derivative of jacobian of EE
            
            MatrixXd r_J_actuated_;     // jacobian of EE
            MatrixXd l_J_actuated_;     // jacobian of EE
