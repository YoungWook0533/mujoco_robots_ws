...
BOOST_PYTHON_MODULE(suhan_robot_model_tools2_wrapper_cpp)
{
  ...
  bp::class_<DualChainConstraintsFunctions, boost::noncopyable>("DualChainConstraintsFunctions",  bp::init<const unsigned int, const unsigned int>())
      ...
      ;
  bp::class_<DualChainConstraintsFunctions6D, boost::noncopyable>("DualChainConstraintsFunctions6D",  bp::init<const unsigned int, const unsigned int>())
      ...
      ;
  bp::class_<DualChainConstraintIK, boost::noncopyable>("DualChainConstraintIK",  bp::init<const unsigned int, const unsigned int>())
  ...
  bp::class_<OrientationConstraintFunctions, boost::noncopyable>("OrientationConstraintFunctions",  bp::init<const unsigned int, const unsigned int>())
  ...
  bp::class_<OrientationConstrainedIK, boost::noncopyable>("OrientationConstrainedIK",  bp::init<const unsigned int, const unsigned int>())
  ...
  bp::class_<MultiChainConstraintFunctions, boost::noncopyable>("MultiChainConstraintFunctions",  bp::init<const unsigned int, const unsigned int>())
  ...
  bp::class_<MultiChainConstraintIK, boost::noncopyable>("MultiChainConstraintIK",  bp::init<const unsigned int, const unsigned int>())
  ...
  bp::class_<MultiChainWithFixedOrientationConstraint, boost::noncopyable>("MultiChainWithFixedOrientationConstraint",  bp::init<const unsigned int, const unsigned int>())
      .def("add_trac_ik_adapter", &MultiChainWithFixedOrientationConstraint::addTRACIKAdapter, bp::return_internal_reference<>())
      .def("get_trac_ik_adapter", &MultiChainWithFixedOrientationConstraint::getTRACIKAdapter, bp::return_internal_reference<>())
      .def("project", &MultiChainWithFixedOrientationConstraint::project)
      .def("jacobian", jacobian1)
      .def("function", &MultiChainWithFixedOrientationConstraint::function)
      .def("set_chains", &MultiChainWithFixedOrientationConstraint::setChains)
      .def("set_chains_from_joints", &MultiChainWithFixedOrientationConstraint::setChainsFromJoints)
      .def("set_orientation_vector", &MultiChainWithFixedOrientationConstraint::setOrientationVector)
      .def("set_orientation_offset", &MultiChainWithFixedOrientationConstraint::setOrientationOffset)
      .def("set_names", &MultiChainWithFixedOrientationConstraint::setNames)
      .def("set_tolerance", &MultiChainWithFixedOrientationConstraint::setTolerance)
      .def("set_max_iterations", &MultiChainWithFixedOrientationConstraint::setMaxIterations)
      .def("set_num_finite_diff", &MultiChainWithFixedOrientationConstraint::setNumFiniteDiff)
      .def("set_rot_error_ratio", &MultiChainWithFixedOrientationConstraint::setRotErrorRatio)
      .def("set_step_size", &MultiChainWithFixedOrientationConstraint::setStepSize)
      .def("set_debug_level", &MultiChainWithFixedOrientationConstraint::setDebugLevel)
      .def("set_early_stopping", &MultiChainWithFixedOrientationConstraint::setEarlyStopping)
     ;
  ...
  bp::class_<PlanningSceneCollisionCheck, boost::noncopyable>("PlanningSceneCollisionCheck", bp::init<const std::string&,const std::string&,const std::string&,const std::string&>())
